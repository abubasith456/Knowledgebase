  ...
  const tabs = [
    {
      ...
      component: <div className="text-center py-20">Upload Component Coming Soon</div>,
    },
    {
      id: 'search',
      ...
      component: <div className="text-center py-20">Search Component Coming Soon</div>,
    },
    {
      id: 'documents',
      ...
      component: <div className="text-center py-20">Documents Component Coming Soon</div>,
    },
    {
      id: 'analytics',
      name: 'Analytics',
      ...
      component: <div className="text-center py-20">Analytics Component Coming Soon</div>,
    },
    {
      id: 'settings',
      name: 'Settings',
      ...
      component: <div className="text-center py-20">Settings Component Coming Soon</div>,
    },
  ];
